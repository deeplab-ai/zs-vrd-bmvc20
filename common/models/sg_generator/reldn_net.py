...
class RelDN(BaseSGGenerator):
    ...
    def __init__(self, config):
        ...
        self.fc_predicate = nn.Sequential(nn.Linear(1024, 256), nn.ReLU())
        ...
        self.subj_classifier = nn.Linear(256, self.num_rel_classes)
        self.obj_classifier = nn.Linear(256, self.num_rel_classes)

        # Spatial features
        self.delta_net = nn.Sequential(
            nn.Linear(22, 64), nn.ReLU(),
            nn.Linear(64, 64), nn.ReLU()
        )
        self.spatial_classifier = nn.Linear(64, self.num_rel_classes)
